...
export default async function HomePage() {
  ...
  return (
    <main className="page-shell" aria-labelledby="page-title">
      ...
      <section className="hero-card" aria-label="Werkzeug: WachSam-Radar">
        <p className="mono-label">Werkzeug</p>
        <p className="lead">
          Vertiefung: Das WachSam-Radar — alle Themen mit Warnstufe im Überblick.
        </p>
        <div className="home-actions">
