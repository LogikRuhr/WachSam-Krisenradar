...
type Observation = { observedAt: Date; value: string };
...
function toNumericSorted(obs: Observation[]): NumericObservation[] {
  return obs
 ...
 */
export function estimateMobilityDelta(obs: Observation[]): CostEstimate | null {
 ...
 */
export function estimateHeatingDelta(obs: Observation[], unit: string | null): CostEstimate | null {
